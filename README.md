...
<img src="https://wyattsheu.github.io/wisdom-assets/" width="100%">
...
卡片內容出自**福智文化**《希望·新生》系列（心之勇士、四季法語等），為真如老師所著，版權屬原出版社所有。
...
小工具上的文字**不可能達到原圖的銳利度**，這是平台限制，不是設定問題。已排除的可能原因與實測數據：

| 環節 | 實測 | 結論 |
|---|---|---|
| 解析度 | 來源 `1320×1840`，widget 需求 `1014×1062` | 有 1.3 倍餘裕，非瓶頸 |
| WebP 壓縮 | q90 vs q98 的 PSNR 僅差 0.8 dB（44.08 → 44.90） | 已接近無損，調高品質無意義 |
| 縮放損耗 | 縮小後銳利度 25.9 → 29.6（不降反升） | 縮放沒有損失細節 |
